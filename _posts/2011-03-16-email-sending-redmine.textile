...
What really got me in the beginning was that ruby has no return statement. Quite simply the last statement of a function is returned to it's caller. If you don't know that about the language, trying to understand what a function does gets quite challenging :)
